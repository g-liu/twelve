 ...
 * 
 * Internally, the IntervalVector class contains a mapping between intervals and their counts.
 * 
 * @author Geoffrey Liu
 *
 */
public class IntervalVector {
	...
	public void add(int interval) {
		...
		// TODO: normalize intervals to be within a minor second and a tritone, inclusive.
