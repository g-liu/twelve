...
public class PitchedNote extends AbstractNote {
	 ...
	 * 
	 * @param pitchClass
	 *            the integer representing the desired PitchClass.
	 */
	...
	/**
	 * Constructs a new instance of PitchedNote. This method is provided, as
	 * some musical sources specify 't' = 10, 'e' = 11, or A = 10, B = 11.
	 * 
	 * @param note
	 *            the character representing the PitchedNote. Must be one of:
	 *            [teAB]
	 */
	public PitchedNote(char note) {
		...
		case 'A':
		case 't':
			this.pitchClass = PitchClass.TEN;
			break;
		case 'B':
		case 'e':
			this.pitchClass = PitchClass.ELEVEN;
			break;
		default:
			throw new IllegalArgumentException("Invalid pitch class: " + note);
		}
	}
